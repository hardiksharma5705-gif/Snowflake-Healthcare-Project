...
FIELD_OPTIONALLY_ENCLOSED_BY = '"';
    ...
    URL='s3://healthcare-regex-2005/CSV files/'
...
URL='s3://healthcare-regex-2005/cost/'
STORAGE_INTEGRATION = s3_int
FILE_FORMAT = csv_format;
...
create or replace stage icd_stage
url='s3://healthcare-regex-2005/icd_files/'
storage_integration=s3_int
...
url='s3://healthcare-regex-2005/json files/'
storage_integration =s3_int 
